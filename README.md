...
The plugin logic is made with [Effect](https://github.com/Effect-TS/effect). There is no particular reason I chose it, it was simply and excuse to try it out.
