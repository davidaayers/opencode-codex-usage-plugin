...
Before doing any other Effect-related work, check that `~/.local/share/opencode/repos/github.com/Effect-TS/effect-smol` exists.
...
3. Effect source code last. For gaps in the guides, complex type errors, unclear behavior, or implementation details, examine the vendored Effect source at `~/.local/share/opencode/repos/github.com/Effect-TS/effect-smol/packages/effect/src/`.
...
- Use the listed repo paths to jump directly into the vendored source under `~/.local/share/opencode/repos/github.com/Effect-TS/effect-smol`.
...
These guides should be treated as the default implementation guidance. Do not skip them and jump straight to `~/.local/share/opencode/repos/github.com/Effect-TS/effect-smol` unless you need source-level confirmation or the guides do not answer the question.
